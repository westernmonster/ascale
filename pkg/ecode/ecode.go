...
func Cause(e error) Codes {
	...
	cmc, ok := errors.Cause(e).(CustomMessageCode)
	if ok {
		return cmc
	}
...
type CustomMessageCode struct {
	Codes
	_Message string
}

func NewCustomMessageCode(code Code, _message string) *CustomMessageCode {
	return &CustomMessageCode{Codes: code, _Message: _message}
}

func (e CustomMessageCode) Message() string {
	return e._Message
}
